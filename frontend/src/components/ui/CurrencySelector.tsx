      ...
      <div className="relative">
        <button
          ...
          className={`flex items-center justify-between gap-2 transition-all group ${
            isCompact 
              ? "px-2.5 py-1.5 rounded-lg bg-white/50 hover:bg-white text-zinc-900 border border-zinc-200 shadow-sm"
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] tracking-wider">{currency}</span>
          </div>
