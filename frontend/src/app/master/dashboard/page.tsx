...
import { Users, ShoppingCart, Package, FileText, BarChart3, Shield, Crown } from "lucide-react";
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <DashboardHeader
        ...
        subtitle="Full platform control for STAFUPRO B2B. Manage admins, approve dealers, monitor orders, and oversee the entire catalog."
        icon={Crown}
        breadcrumbs={[{ label: "Master Console" }]}
        roleBadge={{ label: "Master", type: "master" }}
      />

      <DashboardGrid modules={masterModules} />
