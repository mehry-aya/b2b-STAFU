        ...
        <div className="relative flex items-start justify-between gap-4">
          <div className="space-y-2">
            <div className="flex items-center gap-2 text-red-400 text-xs font-semibold tracking-widest uppercase">
              ...
              <span className="text-red-400">Admin Management</span>
            </div>
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-black text-zinc-900">Add New Admin</h2>
            <p className="text-xs text-zinc-400 mt-0.5">
              They will receive portal access immediately.
            </p>
          </div>
          <button
            onClick={onClose}
